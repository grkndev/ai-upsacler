  ...
  return (
    <>
      ...
      <View className=" p-4 flex flex-col gap-4">
        <View className=" w-full aspect-[10/15.5] rounded-2xl overflow-hidden ">
          <Image
        ...
        <View className=" gap-4">
          <View className="flex-row gap-2 bg-white/10 p-2 rounded-3xl">
            <TouchableOpacity
              onPress={() => setUpTo(0)}
              className={cn(
          ...
          >
            <TouchableOpacity
              className="border-2 border-white/10 p-3 items-center justify-evenly flex-row "
